...
examples = [
  ...
  [14, ")", [t(TOKEN.BRACKETS_CLOSE, ")", 0, 0), eof(0, 1)]]
  [15, ":=", [t(TOKEN.DEF_OP, ":=", 0, 0), eof(0, 2)]]
  [16, "hoge", [t(TOKEN.IDENTIFIER, "hoge", 0, 0), eof(0, 4)]]
  [17, "h_ge", [t(TOKEN.IDENTIFIER, "h_ge", 0, 0), eof(0, 4)]]
  [18, "1234", [t(TOKEN.IDENTIFIER, "1234", 0, 0), eof(0, 4)]]
  [19, "1_34", [t(TOKEN.IDENTIFIER, "1_34", 0, 0), eof(0, 4)]]
  [20, "____", [t(TOKEN.IDENTIFIER, "____", 0, 0), eof(0, 4)]]
  [21, "____", [t(TOKEN.IDENTIFIER, "____", 0, 0), eof(0, 4)]]
  [22, "~!@#$%^&*-+={}[]|:;\"'<>?./", [
